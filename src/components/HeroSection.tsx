...
const HeroSection = forwardRef<HTMLDivElement, HeroSectionProps>(
  (props, ref) => {
    ...
    return (
      <section
        className="HERO-CONTAINER relative md:snap-start flex flex-col md:flex-row justify-around items-center py-20 md:py-40 pb-24 md:pb-36 px-6 aspect-[16/9] h-screen w-full"
        ref={ref}
      >
        <div className="z-10 w-full h-full flex flex-col md:flex-row justify-start md:justify-around items-center mt-12 md:mt-0">
          {/* ------------------ Hero Text start ------------------ */}
